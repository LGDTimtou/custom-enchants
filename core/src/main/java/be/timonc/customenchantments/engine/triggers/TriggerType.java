...
import be.timonc.customenchantments.engine.triggers.impl.armor.ArmorDeEquipTrigger;
import be.timonc.customenchantments.engine.triggers.impl.armor.ArmorEquipTrigger;
import be.timonc.customenchantments.engine.triggers.impl.block.*;
import be.timonc.customenchantments.engine.triggers.impl.block_other.ActivateSculkSensorTrigger;
import be.timonc.customenchantments.engine.triggers.impl.block_other.BellRungTrigger;
import be.timonc.customenchantments.engine.triggers.impl.block_other.ChangeSignTrigger;
import be.timonc.customenchantments.engine.triggers.impl.block_other.PrimeTNTTrigger;
import be.timonc.customenchantments.engine.triggers.impl.chat.PlayerChatTrigger;
import be.timonc.customenchantments.engine.triggers.impl.chat.PlayerReceiveChatTrigger;
import be.timonc.customenchantments.engine.triggers.impl.click.*;
import be.timonc.customenchantments.engine.triggers.impl.damage.DamageAnimalTrigger;
import be.timonc.customenchantments.engine.triggers.impl.damage.DamageEntityTrigger;
import be.timonc.customenchantments.engine.triggers.impl.damage.DamageMobTrigger;
import be.timonc.customenchantments.engine.triggers.impl.damage.DamagePlayerTrigger;
import be.timonc.customenchantments.engine.triggers.impl.death.AnimalDeathTrigger;
import be.timonc.customenchantments.engine.triggers.impl.death.EntityDeathTrigger;
import be.timonc.customenchantments.engine.triggers.impl.death.MobDeathTrigger;
import be.timonc.customenchantments.engine.triggers.impl.death.PlayerDeathTrigger;
import be.timonc.customenchantments.engine.triggers.impl.fishing_rod.FishingRodCaughtTrigger;
import be.timonc.customenchantments.engine.triggers.impl.fishing_rod.FishingRodHitEntityTrigger;
import be.timonc.customenchantments.engine.triggers.impl.fishing_rod.FishingRodHitPlayerTrigger;
import be.timonc.customenchantments.engine.triggers.impl.health_change.*;
import be.timonc.customenchantments.engine.triggers.impl.inventory.InventoryCloseTrigger;
import be.timonc.customenchantments.engine.triggers.impl.inventory.InventoryOpenTrigger;
import be.timonc.customenchantments.engine.triggers.impl.kill.KillAnimalTrigger;
import be.timonc.customenchantments.engine.triggers.impl.kill.KillEntityTrigger;
import be.timonc.customenchantments.engine.triggers.impl.kill.KillMobTrigger;
import be.timonc.customenchantments.engine.triggers.impl.kill.KillPlayerTrigger;
import be.timonc.customenchantments.engine.triggers.impl.movement.*;
import be.timonc.customenchantments.engine.triggers.impl.projectiles.ProjectileHitBlockTrigger;
import be.timonc.customenchantments.engine.triggers.impl.projectiles.ProjectileHitEntityTrigger;
import be.timonc.customenchantments.engine.triggers.impl.projectiles.ProjectileHitPlayerTrigger;
import be.timonc.customenchantments.engine.triggers.impl.projectiles.ProjectileLandTrigger;
