package be.timonc.customenchantments.engine.instructions;

import be.timonc.customenchantments.engine.instructions.types.action.CancelInstruction;
import be.timonc.customenchantments.engine.instructions.types.action.CommandInstruction;
import be.timonc.customenchantments.engine.instructions.types.data.LoadInstruction;
import be.timonc.customenchantments.engine.instructions.types.data.SaveInstruction;
import be.timonc.customenchantments.engine.instructions.types.flow.ConditionalInstruction;
import be.timonc.customenchantments.engine.instructions.types.flow.RepeatInstruction;
import be.timonc.customenchantments.engine.instructions.types.flow.WhileInstruction;
import be.timonc.customenchantments.engine.instructions.types.util.DelayInstruction;
import be.timonc.customenchantments.engine.instructions.types.util.DummyInstruction;
