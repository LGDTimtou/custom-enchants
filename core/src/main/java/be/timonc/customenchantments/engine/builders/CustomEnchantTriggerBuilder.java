package be.timonc.customenchantments.engine.builders;

import be.timonc.customenchantments.engine.model.Level;
import be.timonc.customenchantments.engine.triggers.Trigger;
import be.timonc.customenchantments.engine.triggers.TriggerType;
import be.timonc.customenchantments.engine.triggers.conditions.CustomTriggerCondition;
...
import be.timonc.customenchantments.engine.triggers.conditions.TriggerConditionValue;
