...
import be.timonc.customenchantments.enchantments.custom.triggers.armor.ArmorDeEquipTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.armor.ArmorEquipTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.block.*;
import be.timonc.customenchantments.enchantments.custom.triggers.block_other.ActivateSculkSensorTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.block_other.BellRungTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.block_other.ChangeSignTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.block_other.PrimeTNTTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.chat.PlayerChatTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.chat.PlayerReceiveChatTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.click.*;
import be.timonc.customenchantments.enchantments.custom.triggers.damage.DamageAnimalTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.damage.DamageEntityTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.damage.DamageMobTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.damage.DamagePlayerTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.death.AnimalDeathTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.death.EntityDeathTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.death.MobDeathTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.death.PlayerDeathTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.fishing_rod.FishingRodCaughtTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.fishing_rod.FishingRodHitEntityTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.fishing_rod.FishingRodHitPlayerTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.health_change.*;
import be.timonc.customenchantments.enchantments.custom.triggers.inventory.InventoryCloseTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.inventory.InventoryOpenTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.kill.KillAnimalTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.kill.KillEntityTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.kill.KillMobTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.kill.KillPlayerTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.movement.*;
import be.timonc.customenchantments.enchantments.custom.triggers.projectiles.ProjectileHitBlockTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.projectiles.ProjectileHitEntityTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.projectiles.ProjectileHitPlayerTrigger;
import be.timonc.customenchantments.enchantments.custom.triggers.projectiles.ProjectileLandTrigger;
